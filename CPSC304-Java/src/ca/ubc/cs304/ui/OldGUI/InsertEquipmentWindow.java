...
public class InsertEquipmentWindow extends JFrame {
    // Utility method from SpringUtilities.java

    //no need to implement rn
    ...
    public void showFrame() {
        ...
        String[] labels = {"Tool Name: ", "Tool Usage: ", "Manufacturer: "};
        ...
        JButton button = new JButton("Insert Equipment");
        p.add(button);
        p.add(new Label(""));

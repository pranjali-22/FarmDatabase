...
public class ShowFarmingSupervisorWindow  extends JFrame  {
    ...
    public void showFrame() {
        ...
        String[] labels = {"Farm ID" , "Supervisor ID", "Supervisor Name", "Area", "Location", "Salary", "Bonus"};
        int numPairs = labels.length;
//
//        System.out.printf("Area : %-20.20s", model.getArea());
//        System.out.printf("Location : %-20.20s", model.getLocation());
//        System.out.printf("Supervisor name : %-20.20s", model.getSupervisor_name());
//        System.out.printf("Farm_id : %-20.20s", model.getFarmId());
//        System.out.printf("Supervisor_id : %-20.20s", model.getSupervisor_id());
//        System.out.printf("Supervisor salary : %-20.20s", model.getSalary());
//        System.out.printf("Supervisor bonus : %-20.20s", model.getBonus())

        JPanel p = new JPanel(new SpringLayout());

        //for loop only for filling dummy cols, cuz it wiil return error if missing cols

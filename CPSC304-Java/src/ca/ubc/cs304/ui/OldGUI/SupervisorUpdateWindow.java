...
public class SupervisorUpdateWindow  extends JFrame {
    ...
    public void showFrame() {
        ...
        String[] labels = {"Farm id: ", "Supervisor id: ", "Supervisor Name: ", "Salary: ", "Bonus: "};
        int numPairs = labels.length;

        JPanel p = new JPanel(new SpringLayout());
//        p.add(new Label("Enter the following field you wish to update"));
//        p.add(new Label(""));
        ...
        JButton button = new JButton("Update Supervisor");
        p.add(button);
        p.add(new Label(""));

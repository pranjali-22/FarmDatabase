...
public class Crop_name_quantity {
    JFrame jFrame;
    JPanel jPanel;
    String fid;
    DatabaseConnectionHandler dbHandler;

    public Crop_name_quantity(DatabaseConnectionHandler dbHandler, String fid) {
        this.dbHandler = dbHandler;
        this.fid = fid;
        jFrame = new JFrame("Crop Name Quantity Window");
    ...
    public void addPanelandButtons(JPanel containter) {
        ...
        String[] crop_names = dbHandler.getCrop_name_quantity(fid);
        ...
        JLabel title2 = new JLabel("Quantity");

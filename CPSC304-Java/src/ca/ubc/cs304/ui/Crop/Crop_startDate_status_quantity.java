...
public class Crop_startDate_status_quantity{
    JFrame jFrame;
    JPanel jPanel;
    String fid;
    ...
    public Crop_startDate_status_quantity(DatabaseConnectionHandler dbHandler, String fid) {
    ...
    public void addPanelandButtons(JPanel container) {
        ...
        JPanel gridPanel = new JPanel(new GridLayout(0, 5, 10, 20)); // Grid for the data and titles
...
//        gridPanel.add(title5);
        ...
        // Data
        String[] crop_names = dbHandler.getCrop_startDate_status_quantity(fid);

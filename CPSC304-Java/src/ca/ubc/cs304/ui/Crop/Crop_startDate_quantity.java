...
public class Crop_startDate_quantity{
    JFrame jFrame;
    JPanel jPanel;
    String fid;
    ...
    public Crop_startDate_quantity(DatabaseConnectionHandler dbHandler, String fid) {
...
//        gridPanel.add(title5);
        ...
        // Data
        String[] crop_names = dbHandler.getCrop_startDate_quantity(fid);

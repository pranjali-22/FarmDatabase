...
public class Total_quantity_name_year {
    JFrame jFrame;
    JPanel jPanel;
    String fid;
    DatabaseConnectionHandler dbHandler;

    public Total_quantity_name_year(DatabaseConnectionHandler dbHandler, String fid) {
    ...
    public void addPanelandButtons(JPanel container) {
        ...
        // Data
        String[] crop_names = dbHandler.getTotal_Quantity_Name_Year(fid);
